...
<main class="detail-main">
    ...
    <form method="POST" action="{{ url('/attendance/detail/'.$attendance->id.'/notes') }}" class="detail-card card">
        @csrf
    ...
    <div class="row">
        ...
        <textarea name="reason" rows="3" class="note-input"
            placeholder="備考を入力してください">{{ old('reason', $attendance->request->reason ?? '') }}</textarea>
        </div>
    </div>
